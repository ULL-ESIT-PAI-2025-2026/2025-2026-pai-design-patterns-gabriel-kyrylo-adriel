...
/**
 * @desc Class that represents a generic user with a name, DNI, address and city
...
/**
 * @desc Main entry point for the program that exemplifies what the builder
 * pattern aims to solve.
 */
export function main() {
  // We know the name and dni - constructor seems fine.
  const jorge = new User('Jorge', 12345678);
  console.log(jorge.toString());
  // We only know the name and city...
