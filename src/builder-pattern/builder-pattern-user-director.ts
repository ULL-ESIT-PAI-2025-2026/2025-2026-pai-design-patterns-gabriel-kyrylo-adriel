...
export class User {
  /**
   * @desc Creates an instance of the object User given a name and optionally
   * a DNI, address and city (both as strings). Does not thoroughly check if
   * the input is valid.
...
/**
 * @desc Abstract Builder class to enable polymorphism and unify builders so
 * that the director class can use them.
 * @remarks
...
export class RedUserBuilder extends AbstractUserBuilder {
  ...
  /**
   * @desc Sets the name for the red user.
   * @param name First name of the user.
  ...
  /**
   * @desc Sets the DNI for the red user.
  ...
  /**
   * @desc Sets the address for the red user.
  ...
  /**
   * @desc Sets the city for the red user.
  ...
  /**
   * @desc Resets the builder to its default state.
   */
  reset(): void {
    this.name = '';
    this.dni = undefined;
  ...
  /**
   * @desc Produces the final User object and resets the builder.
...
/**
 * @desc Concrete implementation of a BlueUserBuilder.
...
export class BlueUserBuilder extends AbstractUserBuilder {
  ...
  /**
   * @desc Sets the name with a specific 'Blue' prefix.
   * @param name First name of the user.
   * @return The builder instance for chaining.
   */
  ...
  /**
   * @desc Sets the DNI for the blue user.
   * @param dni National Identity Card.
   * @return The builder instance for chaining.
   */
  ...
  /**
   * @desc Sets the address for the blue user.
   * @param address Simplified address.
   * @return The builder instance for chaining.
   */
  ...
  /**
   * @desc Sets the city for the blue user.
   * @param city Name of the city.
   * @return The builder instance for chaining.
   */
...
/**
 * @desc The director defines the order in which to execute the building steps.
 * @remarks
...
export class UserDirector {
  /**
   * @desc Builds a default user with predefined parameters: name 'x' and city 'LL'.
